# com.thelegends.databuckets.manager


A com.thelegends.databuckets.manager package for the [Unity](https://unity.com/) Game Engine.
...
- Add the `com.thelegends.databuckets.manager` package
